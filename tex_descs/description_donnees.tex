...
\subsubsection{pud} 
 Phrases qui proviennent de sites informatifs, id est de journaux ou de Wikipedia\paragraph{train}
...
\caption{ Mots les plus utilisés } \label{Fig:muw}\end{minipage} 
\begin{minipage}{0.48\textwidth} \centering
\label{Fig:spokentrain_img.png}
\caption{distribution des labels}\includegraphics[width=.7\linewidth]{spokentrain_img.png}
...
\subsubsection{sequoia} 
 Ensemble de texte, à la base disponible avec des annotations «profondes», ie plus complètes. Néanmoins, ces annotations ont été normalisées par rapport aux autres données\paragraph{train}
...
\subsubsection{partut} 
 Ensemble varié de textes, incluant de extraits de conférences comme des extraits de Wikipedia ou des textes légaux\paragraph{train}
\subparagraph{Taille du dataset}803
\begin{figure}[H] \begin{minipage}{0.48\textwidth} \centering \begin{tabular}{|l || *{11 }{|c} |} \hline
Mot & Apparitions  \\ \hline
\begin{verb} de \end{verb} &1114\\ \hline
...
\caption{ Mots les plus utilisés } \label{Fig:muw}\end{minipage} 
\begin{minipage}{0.48\textwidth} \centering
\label{Fig:gsdtrain_img.png}
\caption{distribution des labels}\includegraphics[width=.7\linewidth]{gsdtrain_img.png}
...
\caption{ Mots les plus utilisés } \label{Fig:muw}\end{minipage} 
\begin{minipage}{0.48\textwidth} \centering
\label{Fig:natdistest_img.png}
\caption{distribution des labels}\includegraphics[width=.7\linewidth]{natdistest_img.png}
